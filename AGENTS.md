...
- **Project Code**: `LETTA`
- **Project Name**: Letta OpenCode Plugin
- **Letta Agent ID**: `agent-0623f440-dc16-49ab-a5e6-c9ccb22fa726`

## Workflow Instructions

1. **Before starting work**: Search Huly for related issues using `huly-mcp` with project code `LETTA`
2. **Issue references**: All issues for this project use the format `LETTA-XXX` (e.g., `LETTA-123`)
...
**Project PM Agent:** `Huly - Letta OpenCode Plugin` (agent-0623f440-dc16-49ab-a5e6-c9ccb22fa726)
...
```json
{
  ...
  "agent": "Huly - Letta OpenCode Plugin",
  "message": "<your report>",
  "caller_directory": "/opt/stacks/letta-opencode-plugin"
}
```
...
**Project**: Letta OpenCode Plugin (`LETTA`)
