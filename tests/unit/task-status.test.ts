import { getTaskStatus, type GetTaskStatusParams, type TaskStatusDependencies } from "../../src/tools/task-status-tools.js";
...
describe("getTaskStatus", () => {
  ...
  describe("Workspace events", () => {
    ...
    it("should handle workspace fetch errors gracefully", async () => {
      ...
      mockRegistry.getTask.mockReturnValue(mockTask as any);
      mockWorkspace.getWorkspace.mockRejectedValue(
